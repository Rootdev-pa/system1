    ...
    <div class="flex flex-wrap w-full justify-center items-center pt-12">
        <div class="flex flex-wrap max-w-xl">
            ...
            <div class="p-2 w-full mt-4">
                <button v-on:click.prevent="saveForm" type="submit" class="flex text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-500 rounded text-lg">
                    Crear Cuenta
                </button>
            </div>
        </div>
